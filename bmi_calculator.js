...
//Height in inches
//Weight in kg
console.log(calculateBMI(180,40)); //Correct
console.log(calculateBMI(180,55));  //Correct
console.log(calculateBMI(180,58));  //Correct
console.log(calculateBMI(180,60));  //Correct
console.log(calculateBMI(180,85));  //Correct
console.log(calculateBMI(180,100));  //Correct
console.log(calculateBMI(180,120));  //Correct
console.log(calculateBMI(180,150));  //Correct
...
let bmitest = (150 / ((180 * 180) / 10000)).toFixed(2);
console.log(bmitest);